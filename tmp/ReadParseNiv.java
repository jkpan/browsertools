...
public class ReadParseNiv {
  ...
  static String abbr[] = { "Gen",//).preReadline("Ge.", "Exodus");
                     ...
                     "1Sa",//).preReadline("1Sa.", "2 Samuel");
                     "2Sa",//).preReadline("2Sa.", "1 Kings");
                     "1Ki",//).preReadline("1Kg.", "2 Kings");
                     "2Ki",//).preReadline("2Kg.", "1 Chronicles");
                     "1Ch",//).preReadline("1Ch.", "2 Chronicles");
                     "2Ch",//).preReadline("2Ch.", "Ezra");
                     ...
                     "1Co",//).preReadline("1 Corinthians", "2 Corinthians");
                     "2Co",//).preReadline("2 Corinthians", "Galatians");
                     ...
                     "1Ts",//).preReadline("1 Thessalonians", "2 Thessalonians");
                     "2Ts",//).preReadline("2 Thessalonians", "1 Timothy");
                     "1Ti",//).preReadline("1 Timothy", "2 Timothy");
                     "2Ti",//).preReadline("2 Timothy", "Titus");
                     "Tit",//).preReadline("Titus", "Philemon");
                     "Phm",//).preReadline("Philemon", "Hebrews");
                     "Heb",//).preReadline("Hebrews", "James");
                     "Jas",//).preReadline("James", "1 Peter");
                     "1Pe",//).preReadline("1 Peter", "2 Peter");
                     "2Pe",//).preReadline("2 Peter", "1 John");
                     "1Jn",//).preReadline("1 John", "2 John");
                     "2Jn",//).preReadline("2 John", "3 John");
                     "3Jn",//).preReadline("3 John", "Jude");
